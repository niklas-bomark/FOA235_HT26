...
1.  **K-means cluster analysis:** Read Sections 12.1, 12.4, and 12.4.1.
2.  **Multiple linear regression:** Read Sections 3.0, 3.1, and 3.1.1.
3.  **Logistic regression:** Read Sections 4.1, 4.2, 4.3.1, and 4.3.2.
...
Lets plot the relationship between age and income:
...
#### Step 2: Start with cluster centers
...
Run K-means with three clusters using the following code. The algorithm will: take the standardized data, divide the observations into three clusters, try 25 different starting solutions, keep the best solution, and save the result as an object which we name 'km'.
...
```{r}
df_km$cluster <- factor(km$cluster)
```
...
1.  **the business or research question**,
2.  **model specification**,
3.  **running the model in R**,
4.  **interpreting the results**,
5.  **evaluating model performance**,
6.  **and deciding whether the model is useful for the problem we want to solve**.
