...
```{r}
df <- read.csv("../Data/logistic_data2.csv")
```
...
3.  What do the values 0 and 1 represent?
4.  Which variables could potentially be used as predictors?
...
1.  What percentage of customers purchased the product?
2.  What percentage did not purchase the product?
3.  Are the two classes approximately balanced?
4.  Why might class balance matter when evaluating a classification model?
...
1.  Do customers who purchase appear different from customers who do not purchase?
2.  Do customers who purchase generally have more or fewer website visits?
3.  Which other variables might be useful for predicting purchase?
...
2.  How many observations are in the test data?
3.  What is the purpose of the training data?
4.  What is the purpose of the test data?
...
2.  Which model is the most complicated?
3.  Why might adding more predictors improve classification?
4.  Why might a more complicated model not necessarily make better predictions for new observations?
...
We can also sort the models from highest to lowest accuracy.
...
1.  Which model has the highest training accuracy?
2.  Which model has the lowest training accuracy?
3.  Does adding more predictors improve training accuracy?
4.  How large are the differences between the models?
5.  Does Model 3 perform substantially better than Model 2?
...
5.  Which measure has the highest value?
6.  Which measure has the lowest value?
7.  Does the model appear to classify new observations reasonably well?

## Classification Errors and the Business Problem
...
1.  What is the potential cost of a false positive?
2.  What is the potential cost of a false negative?
3.  Which error do you think is more important for this company?
...
1.  Which three models did you compare?
2.  Which predictors were included in each model?
3.  Which model had the highest training accuracy?
4.  Which model did you select?
5.  Why did you select this model?

### Test Performance

6.  What is the test accuracy?
7.  What is the test precision?
8.  What is the test recall?
9.  What is the test specificity?
10. How many false positives did the model produce?
11. How many false negatives did the model produce?

### Business Decision

12. Which type of classification error is most important for this business problem?
13. Which performance measure is therefore especially important?
14. Does the model perform sufficiently well on this measure?
15. Would you recommend that the company implement the model?
...
We have now extended the classification workflow from the previous lab.

### 1. Define the business problem

What do we want to classify, and why?

### 2. Identify the outcome and predictors

What is the binary outcome, and what information can we use to predict it?
...
### 6. Convert probabilities into classes

Use a classification threshold to generate predicted classes.
...
Choose a model based on accuracy, complexity, and other relevant considerations.

### 9. Evaluate on test data

Evaluate the selected model using observations that were not used to fit it.

### 10. Examine classification errors

Use the confusion matrix, accuracy, precision, recall, and specificity.

### 11. Make a business decision

Decide whether the model is useful enough to implement.

## Lab 2 Summary

In the previous lab, we introduced logistic regression and learned how predicted probabilities can be converted into predicted classes. In this lab, we extended the classification workflow by comparing several logistic regression models.

The workflow was:

1.  split the data into training and test data;
2.  fit several candidate models using the training data;
3.  generate predicted probabilities;
4.  convert probabilities into classes;
5.  compare the training accuracy of the candidate models;
6.  select one model;
7.  evaluate the selected model using the test data;
8.  calculate accuracy, precision, recall, and specificity;
9.  examine false positives and false negatives;
10. make a business recommendation.

The two datasets have different roles:

-   **training data** are used to fit and compare models;
-   **test data** are used to evaluate how well the selected model performs on new observations.

For the initial model comparison, we used **accuracy**.

For the final selected model, we used four measures:

-   **Accuracy:** Of all observations, how many were classified correctly?
-   **Precision:** Of all observations predicted to be positive, how many were actually positive?
-   **Recall:** Of all actual positive observations, how many did the model identify?
-   **Specificity:** Of all actual negative observations, how many did the model correctly identify?

These measures provide different information about classification performance. There is therefore no single measure that is always the most important. The appropriate measure depends partly on the **business consequences of false positives and false negatives**.

The important workflow is:

**Training data → fit and compare models**

**Test data → evaluate the selected model**

**Business problem → make a decision**
